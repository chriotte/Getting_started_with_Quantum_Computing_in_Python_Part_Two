...
'''
Initialise the quantum engine, we are using a Simulator here,
but IBMs quantum computer is also supported by ProjectQ
'''
...
received_bit = message_reciever(quantum_engine, classical_encoded_message, qubit_two)
